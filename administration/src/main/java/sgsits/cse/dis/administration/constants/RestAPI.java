...
public class RestAPI {
	...
	public static final String GET_RESOLVED_CLEANLINESS_COMPLAINTS = "/getResolvedClenalinessComplaints";
	...
	public static final String DOWNLOAD_FILE = "/downloadFile/{fileId}";
	
	public static final String GET_OVERVIEW_DETAILS = "/getOverviewDetails";
	...
	public static final String GET_BE_THESIS_COUNT = "/getThesisBECount";
	public static final String GET_BE_THESIS_LIST = "/getThesisBEList";
	public static final String ADD_BE_THESIS = "";
	public static final String EDIT_BE_THESIS = "";
	public static final String SEARCH_BE_THESIS = "";
	
	public static final String GET_ME_THESIS_COUNT = "/getThesisMECount";
